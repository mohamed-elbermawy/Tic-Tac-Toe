...
public class LoginController implements Initializable {
    ...
    public static String usernamePlayer;
...
//    public App app = new App("127.0.0.1");
    ...
    void loginProccess(ActionEvent event) throws IOException {
        if (username.getText().isEmpty() || password.getText().isEmpty()) {
            ...
            if (login(username.getText().toString(), password.getText().toString())) {
                usernamePlayer = username.getText().toString();
                score = userinfo.split(",")[3];
    ...
    boolean login(String username, String password) {
        ...
        out.flush();
        userinfo = in.nextLine();
        System.out.println(userinfo);
        line = parseBoolean(userinfo.split(",")[0]);
        return line;
    }
